...
INSERT INTO `testimoniales` (`nombre`, `correo`, `mensaje`, `id`) VALUES
('tobias', 'tobias@correo.com', 'otro mensaje a continuacion', 2),
('manuel', 'correo@correo.com', 'un mensaje muy largo!', 6),
('Juan', 'correo@correo.com', 'menjaje', 9);
